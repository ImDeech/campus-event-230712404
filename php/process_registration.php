...
<body>
    ...
    <div class="footer-main home-footer status-footer"><div class="footer-columns"><div class="footer-contact"><img src="../images/UAJY-LOGOGRAM_V.5b7a003.png" alt="Logo Universitas Atma Jaya Yogyakarta" class="footer-logo" /><p>Kampus II Gedung Thomas Aquinas<br />Jalan Babarsari 44 Yogyakarta<br />&#9742; 0274-487711<br />&#9993; Humas@uajy.ac.id</p></div><div class="footer-about"><strong>ABOUT</strong><p>Universitas Atma Jaya Yogyakarta (UAJY) is a private university founded by the laity and managed by Slamet Rijadi Foundation - Yogyakarta, under the patronage of Saint Albert Magnus sigma</p><p>UAJY was established on September 27, 1965, aiming to participate in educating nation with a local dimension and global orientation.</p></div></div><div class="footer-copyright">&#169; 2026. Rafael Venansius Anastasios Devin - 230712404</div></div>
